...
const FeaturesBox = () => {
  ...
  return (
    <section id="features" ref={containerRef} className="py-24 md:py-32 px-6 md:px-16 w-full bg-peakWhite dark:bg-peakDark transition-colors">
      <div className="max-w-7xl mx-auto">
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-4 md:grid-rows-2">
          ...
          {/* Medium Item */}
          <div className="bento-item md:col-span-2 bg-white dark:bg-white/[0.03] border border-black/5 dark:border-white/10 rounded-3xl p-8 hover:shadow-lg dark:hover:shadow-peakGreen/5 transition-all duration-300">
          ...
          {/* Small Item 1 */}
          <div className="bento-item md:col-span-1 bg-white dark:bg-white/[0.03] border border-black/5 dark:border-white/10 rounded-3xl p-8 hover:shadow-lg dark:hover:shadow-peakGreen/5 transition-all duration-300">
